...
# -*- coding: utf-8 -*-
"""
双 Logistic 回归模型：分别预测 MA5 / MA20 方向，加权综合。
"""
...
class DualLogisticModel(BaseModel):
    name = 'dual_logistic'
    ...
    def fit(self, df: pd.DataFrame) -> None:
        ...
        self.model_ma5 = LogisticRegression(max_iter=1000, class_weight='balanced')
        self.model_ma5.fit(X, y_ma5)

        self.model_ma20 = LogisticRegression(max_iter=1000, class_weight='balanced')
